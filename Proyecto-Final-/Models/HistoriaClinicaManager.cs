...
namespace Proyecto_Final_.Models
{
    public class HistoriaClinicaManager
    {
        ...
        public void InsertarHistoriaClinica(HistoriaClinica Paciente)
        {
            ...
            Sentencia.CommandText = "INSERT INTO HistoriaClinica(ApellidoyNombre, DNI, Nacionalidad, Genero, EstadoCivil, FechaNacimiento, EstudiosAlcanzados, Carrera, Ocupacion, Residencia, VSVinculo, VSApellidoyNombre, VSFechaNacimiento, VSOcupacion, VSConvive, ObraSocial, Plan, Credencial, Observaciones, Sintomas, DFecha, DDSM, DNombre, MApellidoyNombre, Especialidad, Contacto, Droga, Dosis, Celular, Telefono, Email, Skype, Direccion, NRNombreyVinculo, NRNumero) VALUES(@ApellidoyNombre, @DNI, @Nacionalidad, @Genero, @EstadoCivil, @FechaNacimiento, @EstudiosAlcanzados, @Carrera, @Ocupacion, @Residencia, @VSVinculo, @VSApellidoyNombre, @VSFechaNacimiento, @VSOcupacion, @VSConvive, @ObraSocial, @Plan, @Credencial, @Observaciones, @Sintomas, @DFecha, @DDSM, @DNombre, @MApellidoyNombre, @Especialidad, @Contacto, @Droga, @Dosis, @Celular, @Telefono, @Email, @Skype, @Direccion, @NRNombreyVinculo, @NRNumero)";
            ...
            Sentencia.Parameters.AddWithValue(@"Plan", Paciente.Plan); 
